...
public class GenerateCards {
    ...
    public static ArrayList<Card> generateCommonCards() {
        ...
        cardList.add(new Card("+Crit Dmg", "critdamage = 0.45"));
    ...
    public static ArrayList<Card> generateEpicCards() {
        ...
        cardList.add(new Card("Crit Master", "critchance = 0.06, critdamage = 0.40"));
        for (int i = 0; i < cardList.size(); i++) {
    ...
    public static ArrayList<Card> generateLegendaryCards() {
        ...
        cardList.add(new Card("Devil's Deal", "attack = 8, ballspeed = 0.05, ballsize = -0.13, lives = -2"));
    ...
    public static ArrayList<Card> generateMythicCards() {
        ...
        cardList.add(new Card("Lucifer's Contract", "attack = 13, ballspeed = 0.0666, ballsize = -0.1666, lives = -3, critdamage = 0.666, critchance = 0.0666, luck = -0.666"));
        cardList.add(new Card("The Honored One", "attack = 4, ballsize = 0.11, critchance = 0.055, critdamage = 0.33"));
        cardList.add(new Card("God's Blessing", "attack = 2, pierce = 2, lives = 2, ballspeed = -0.02, ballsize = 0.02, platformwidth = 0.02, platformspeed = 0.02, luck = 0.2, critchance = 0.02, critdamage = 0.2"));
