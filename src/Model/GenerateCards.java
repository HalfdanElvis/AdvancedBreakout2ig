...
public class GenerateCards {
    ...
    public static ArrayList<Card> generateCommonCards() {
        ...
        cardList.add(new Card("+Size", 0, 0, 0, 4, 0, 0, 0));
        cardList.add(new Card("+Platform Speed", 0, 0, 0, 0, 1, 0, 0));
    ...
    public static ArrayList<Card> generateLegendaryCards() {
        ...
        cardList.add(new Card("Better Platform", 0, 0, 0, 0, 1, 30, 0));
        cardList.add(new Card("Bullet", 5, 1, 1, 1, 0, 0, 0));
        cardList.add(new Card("Wreckingball", 0, 0, 3, 2, 1, 0, 0));
        cardList.add(new Card("Devil's Deal", 8, 0.3, 0, 0, 0, 0, -2));
        cardList.add(new Card("Giant", 0, -0.5, 0, 20, 0, 0, 0));
